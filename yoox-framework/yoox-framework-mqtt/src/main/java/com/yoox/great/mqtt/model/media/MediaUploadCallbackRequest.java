...
public class MediaUploadCallbackRequest {
    ...
    @NotNull
    @Schema(description = "media file name", example = "YOOX_20220831151616_0004_W_Waypoint4.JPG")
    private String name;

    @Schema(description = "media file path. This value is empty if the photo was not taken in the wayline.", example = "YOOX_202208311455_008_Waypoint1")
    private String path;

    @JsonProperty("object_key")
    @NotNull
    @Schema(description = "The key of the object in the bucket", example = "media/YOOX_20220831151616_0004_W_Waypoint4.JPG")

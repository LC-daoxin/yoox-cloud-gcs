...
public enum DebugErrorCodeEnum implements IServicesErrorCode, IEventsErrorCode, IErrorInfo {
    ...
    AIRCRAFT_NO_DONGLE(326002, "The YOOX Cellular module is not installed on the aircraft."),

    AIRCRAFT_DONGLE_NO_SIM(326003, "There is no SIM card installed in the YOOX Cellular module of the aircraft."),

    AIRCRAFT_DONGLE_NEED_UPGRADE(326004, "The YOOX Cellular module of the aircraft needs to be upgraded, otherwise it cannot be used."),
    ...
    DOCK_NO_DONGLE(326008, "The YOOX Cellular module is not installed on the dock."),

    DOCK_DONGLE_NO_SIM(326009, "There is no SIM card installed in the YOOX Cellular module of the dock."),

    DOCK_DONGLE_NEED_UPGRADE(326010, "The YOOX Cellular module of the dock needs to be upgraded, otherwise it cannot be used."),

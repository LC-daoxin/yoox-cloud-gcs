...
VALUES
    ...
    (12, 2, 20119, 0, 'YOOX Smart Controller V3', 'EVO Max 系列配套遥控器'),
    (13, 2, 20121, 0, '8.3寸遥控器', NULL),
    (14, 3, 30000, 0, 'YOOX Virtual Nest', '道通虚拟机巣'),
    (15, 3, 30001, 0, 'EVO Nest', '道通多旋翼机巣'),
    (16, 3, 30002, 0, 'YOOX Dragonfish Nest', '道通龙鱼机巣'),
    (17, 3, 30004, 0, 'YOOX Nest2', '道通机巣二代');
...
CREATE TABLE `manage_user` (
  ...
  `mqtt_password` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'The account password used by the current account when logging into the emqx server.',
  `create_time` bigint NOT NULL,
  `update_time` bigint NOT NULL,
  PRIMARY KEY (`id`),
